...
print([[
   ...
   _ _ _ __           ____ _         __        __     __ _ __ _ _             _ __ _ _ __
   |_| _ _| |        / /   _ \ \      |  | \    /|  |    |  | _\    |  |           |_ _ _ __|  |
   | |  \ \         /  /  /__ \ \    |  |  \ / |   |    |  | ___/ /  |           |  |      |  |
   |_|   \_\        /  / __ | _ \ \   |  |      |   |    |  | _\   \  |          |  |      |  |
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 𝒔𝒐𝒖𝒓𝒄𝒆 ☁⁽♔₎| 𝐑𝐀𝐌𝐁𝐎 |⁽♔₎☁")  
...
os.execute('wget https://raw.githubusercontent.com/exAhmed200/EX/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,' ☁️ تم تحديث السور س \n ☁️ لديك اخر اصدار لسورس رامبو \n ☁️ الاصدار☁️ { v 7.0}')
dofile('DRAGON.lua')  
end
if text == 'الاصدار' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ☁️ اصدار سورس رامبو\n ☁️ الاصدار☁️{ v 7.0}')
end

if text ==  مبرمجين  السورس  and DevSoFi(msg) then
database:del(bot_id.. Srt:Bot ) 
local Text = [[ 
[Ahmed ](t.me/D_V_A7_Me_d)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text =  ☁️⁽♔₎𝙳𝚅 𝙰𝙷𝙼𝙴𝙳|:☁ , url="t.me/D_V_A7_Me_d"}}, 
} 
...
database:del(bot_id.. Srt:Bot ) 
local Text = [[ 
[Rambo](t.me/So0u_rce_Line)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text =  قناه السورس️️ , url="t.me/if text ==  مبرمجين السورس  and DevSoFi(msg) then
database:del(bot_id.. Srt:Bot ) 
local Text = [[ 
[Bebo ](t.me/D_V_B_a_h_e_r)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text =  ☁️ ⁽♔₎𝙳𝚅 𝙱𝙴𝙱𝙾 |:☁ , url="t.me/
D_V_B_a_h_e_r"}}, 
} 
local msg_id = msg.id_/1330033222/0.5 
https.request("https://api.telegram.org/bot"..token.. /sendMessage?chat_id=  .. msg.chat_id_ ..  &text=  .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text ==  قناه السورس  and DevSoFi(msg) then
database:del(bot_id.. Srt:Bot ) 
...
database:del(bot_id.. Srt:Bot ) 
local Text = [[ 
[TWL](t.me/TW_rambo_bot)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text =  𖤓☁TＷＡＳＯＬ☁𖤓 , url="t.me/TW _rambo_bot"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token.. /sendMessage?chat_id=  .. msg.chat_id_ ..  &text=  .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end"}}, 
...
database:del(bot_id.. Srt:Bot ) 
local Text = [[ 
[Rambo](t.me/TW_rambo_bot)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text =  𖤓TＷＡＳＯＬ𖤓 , url="t.me/
TW_rambo_bot"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token.. /sendMessage?chat_id=  .. msg.chat_id_ ..  &text=  .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
...
usertext = '\n ☁️ العضو ☁️ ['..result.title_..'](t.me/'..(username or 'So0u_rce_Line')..')'
status  = '\n ☁️ تم ترقيته مطور'
...
usertext = '\n ☁️ العضو ☁️ ['..data.first_name_..'](t.me/'..(data.username_ or 'So0u_rce_Line')..')'
status  = '\n ☁️ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ☁️ العضو ☁️ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'So0u_rce_Line')..') \n ☁️ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ☁️ العضو : {["..data.first_name_.."](T.ME/So0u_rce_Line)}\n ☁️ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ☁️ عذرا ☁️ {["..data.first_name_.."](T.ME/So0u_rce_Line)}\n ☁️ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text = [[
🧚‍♀️W𝒆𝒍𝒄𝒐𝒎𝒆 𝒕𝒐 𝒕𝒉𝒆 ☁⁽♔₎| 𝐑𝐀𝐌𝐁𝐎 |⁽♔₎☁🧚‍♀️
🧚‍♀️مرحب بيك في سورس رامبو الاعظم🧚‍♀️
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ☁️  ⁽♔₎𝙳𝚅 𝙰𝙷𝙼𝙴𝙳|:☁️ ',url="t.me/D_V_A7_Me_d"}},
{{text = '☁️  ⁽♔₎𝙳𝚅 𝙱𝙴𝙱𝙾 |: ☁️',url="t.me/D_V_B_a_h_e_r"}},
{{text = '☁️ ⁽♔₎| 𝐑𝐀𝐌𝐁𝐎 |⁽♔₎☁️', url="t.me/barfrends"}},
{{text = '☁️ 𝑺𝑶𝑼𝑹𝑪𝑬 ☁⁽♔₎| 𝐑𝐀𝐌𝐁𝐎 |⁽♔₎☁  ☁️', url="t.me/So0u_rce_Line"}},
{{text = '☁️ 𝑻𝑶 𝑨𝑺𝑲  ☁️',url="t.me/TW_rambo_bot"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '☁⁽♔₎𝙳𝚅 𝙰𝙷𝙼𝙴𝙳|:☁ ☁️',url="t.me/D_V_A7_Me_d"}},
{{text = '⌯｟TＷＡＳＯＬ｠⌯',url="t.me/TW_rambo_bot"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'احمد' or text == 'Ahmed' or text == 'Ahmed' then
local Text = [[
المبرمج احمد لو حابب تتواصل معاه
اتبع الزر إلى تحت ⬇️
...
if text == 'بيبو' or text == 'Bebo' or text == 'Bebo' then
local Text = [[
المبرمج بيبو 
اتبع الزر إلى تحت ⬇️
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '☁️ Bebo ☁️',url="t.me/D_V_B_a_h_e_r"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '☁️ ⁽♔₎𝚂𝙾𝚄𝚁𝙲𝙴❀𝚁𝙰𝙼𝙱𝙾|: ☁️', url="t.me/So0u_rce_Line"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𖤓TＷＡＳＯＬ𖤓', url="t.me/TW_rambo_bot"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '☁⁽♔₎𝙳𝚅 𝙱𝙴𝙱𝙾 |:☁️', url="t.me/D_V_B_a_h_e_r"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
{{text = '☁️ ❪SＯＵＲＣＥ❫ ☁️', url="t.me/So0u_rce_Line"}},
}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))  
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ☁️ بواسطه ☁️ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'So0u_rce_Line')..') \n ☁️ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ☁️ بواسطه ☁️ ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'So0u_rce_Line')..') \n ☁️ تـم قفـل التاك بالكتم ')
end,nil)   
...
if Get_info then
local TextS = "\n ☁️ اهلا بك في متجر ملفات رامبو\n ☁️ ملفات السورس ↓\n⩹━━━━━━ ☁⁽♔₎| 𝐑𝐀𝐌𝐁𝐎 |⁽♔₎☁ ━━━━━━⩺\n\n"
local TextE = "\n⩹━━━━━━ ☁⁽♔₎| 𝐑𝐀𝐌𝐁𝐎 |⁽♔₎☁ ━━━━━━⩺\n ☁️ علامة تعني { ✔️ } ملف مفعل\n ☁️ علامة تعني { ✖ } ملف معطل\n ☁️ قناة سورس رامبو↓\n".." ☁️ [اضغط هنا لدخول](t.me/So0u_rce_Line) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," ☁️ عذرا الملف لايدعم سورس رامبو\n") 
end
return false
end
...
if #list == 0 then
t = " ☁️ لا يوجد احد في قائمه رامبو"
end
send(msg.chat_id_, msg.id_, t)
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ☁️ لعضو ☁️ ['..data.first_name_..'](t.me/'..(data.username_ or 'So0u_rce_Line')..')'
status  = '\n ☁️ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ☁️ العضو ☁️ '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ☁️ العضــو ☁️ ['..data.first_name_..'](t.me/'..(data.username_ or 'So0u_rce_Line')..')'
...
' }\n'..' ☁️  الرفع ☁️ { '..setadd..
' }\n'..' ☁️  الحظر ☁️ { '..banm..' }\n\n⩹━━━━━━ ☁⁽♔₎| 𝐑𝐀𝐌𝐁𝐎 |⁽♔₎☁ ━━━━━━⩺\n ☁️ قناة سورس رامبو ↓\n [ 𝒔𝒐𝒖𝒓𝒄𝒆 ☁⁽♔₎| 𝐑𝐀𝐌𝐁𝐎 |⁽♔₎☁](t.me/So0u_rce_Line) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ☁️ العضو ☁️ ['..result.title_..'](t.me/'..(text1[3] or 'So0u_rce_Line')..')'..'\n ☁️ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐀𝐍𝐆𝐄??𝐒.',url="t.me/So0u_rce_Line"}},
}
local msg_id = msg.id_/2097152/0.5
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[يولا يا وسخ 🥵](t.me/So0u_rce_Line)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[الحمد لله يقلبي ❤️](t.me/So0u_rce_Line)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[اوماااااال يا جدع 😹❤️](t.me/So0u_rce_Line)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[تيب تيب يعسل 😁](t.me/So0u_rce_Line)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[بلاش نكد بحبك 😁 ](t.me/So0u_rce_Line)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[يستر عايز اي 🤭](t.me/So0u_rce_Line)') 
return false
end
end
end
...
اتبع الازرار تحت ⇣
واستمتع للأوامر 🕹️
[☁️ 𝒔𝒐𝒖𝒓𝒄𝒆 ☁⁽♔₎| 𝐑𝐀𝐌𝐁𝐎 |⁽♔₎☁ ☁️](t.me/So0u_rce_Line)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = ' 𝒔𝒐𝒖𝒓𝒄𝒆 ☁⁽♔₎| 𝐑𝐀𝐌𝐁𝐎 |⁽♔₎☁', url="t.me/So0u_rce_Line"},
...
{
{text = '??𝒐𝒖𝒓𝒄𝒆 ☁⁽♔₎| 𝐑𝐀𝐌𝐁𝐎 |⁽♔₎☁', url="t.me/So0u_rce_Line"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
*الكيبورد الموجود في الأسفل*
⩹━━━━━━  ━━━━━━⩺
[ 𝚂𝙾𝚄𝚁𝙲𝙴 R𝙰𝙼𝙱𝙾⁦㉨ ](t.me/So0u_rce_Line)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text =`𝚂𝙾𝚄𝚁𝙲𝙴 R𝙰𝙼𝙱𝙾⁦㉨ , url="t.me/So0u_rce_Line"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
