...
send(msg.chat_id_, msg.id_,' 〄︙ تم تحديث السورس \n 〄︙ لديك اخر اصدار لسورس رامبو\n 〄︙ الاصدار » {v2.5.0}')
dofile('DRAGON.lua')  
end
if text == 'الاصدار 〄' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' 〄︙ اصدار سورس رامبو \n 〄︙ الاصدار »{v2.5.0}')
end
...
usertext = '\n 〄︙ العضو » ['..result.title_..'](t.me/'..(username or 'So0u_rce_Line')..')'
status  = '\n 〄︙ تم ترقيته مطور'
...
usertext = '\n 〄︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'So0u_rce_Line')..')'
status  = '\n 〄︙ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 〄︙ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'So0u_rce_Line')..') \n 〄︙ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' 〄︙ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'So0u_rce_Line')..') \n 〄︙ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 〄︙ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'So0u_rce_Line')..') \n 〄︙ تـم قفـل التاك بالكتم ')
end,nil)   
...
send(msg.chat_id_, msg.id_, " 〄︙ لا تسطيع حظر مـبـرمـج الـسـورس عام")
return false 
end
...
send(msg.chat_id_, msg.id_, " 〄︙ لا تسطيع حظر مـبرمج السورس عام")
return false 
end
...
send(msg.chat_id_, msg.id_, " 〄︙ لا يمكنك حظر مـبـرمـج الـسـورس \n")
return false 
end
...
send(msg.chat_id_, msg.id_, " 〄︙ لا يمكنك حظر مـبرمج السورس \n")
return false 
end
usertext = '\n 〄︙ العضو » ['..result.title_..'](t.me/'..(username or 'So0u_rce_Line')..')'
status  = '\n 〄︙ تم حظره عام من الجروبات'
...
if tonumber(result.sender_user_id_) == tonumber(944353237) then  
send(msg.chat_id_, msg.id_, " 〄︙ لا تسطيع كتم مـبـرمـج الـسـورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1330033222) then  
...
if tonumber(result.sender_user_id_) == tonumber(1293533064) then  
send(msg.chat_id_, msg.id_, " 〄︙ لا تسطيع كتم مـبرمج السورس عام")
return false 
end
...
if result.id_ == tonumber(944353237) then
send(msg.chat_id_, msg.id_, " 〄︙ لا يمكنك كتم مـبـرمـج الـسـورس \n")
return false 
end
if result.id_ == tonumber(1330033222) then
...
if result.id_ == tonumber(1293533064) then
send(msg.chat_id_, msg.id_, " 〄︙ لا يمكنك كتم مـبرمج السورس \n")
return false 
end
usertext = '\n 〄︙ العضو » ['..result.title_..'](t.me/'..(username or 'So0u_rce_Line')..')'
status  = '\n 〄︙ تم كتمه عام من الجروبات'
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 〄︙ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'So0u_rce_Line')..')'
status  = '\n 〄︙ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n 〄︙ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 〄︙ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'So0u_rce_Line')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n 〄︙ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'So0u_rce_Line')..')'..'\n 〄︙ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
local DRAGON_Msg = {
'قلبوو 🥺💕.',
'ياروحي اتكلم  انا '..Namebot..'',
'عايز اي يعم من '..Namebot..'',
'دوختوني ينعل ميتين امكم  '..Namebot..'',
' كفايه زفت يجدع  😡🤬',
'وبعدين معاك ؟ 🥺',
'انا معنديش دماغ انت وجعتها  🥵😓',
'هاا أرغى عايزاي  ☹️.',
'والمصحف انا بوت 😂.',
'قول ي حبيبي ؟ انا  '..Namebot..'',
'عمري فداك '..Namebot..' ينعل ميتين امك '
}
